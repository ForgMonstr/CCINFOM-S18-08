...
public class Forecasting {
    ...
    public static class ForecastAccuracy {
        ...
        public final int actualDemand;
        public final double predictedDemand;
        public final double accuracyPercentage;

        public ForecastAccuracy(String branchId, YearMonth month, int actualDemand, double predictedDemand) {
            this.branchId = branchId;
            this.month = month;
            this.actualDemand = actualDemand;
            this.predictedDemand = predictedDemand;
            this.accuracyPercentage = actualDemand == 0 ? 0.0 : (1 - Math.abs(predictedDemand - actualDemand) / actualDemand) * 100;
        }
